...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2024 a las 22:26:54
...
INSERT INTO `autores` (`ID_Autores`, `Nombre`, `Nacionalidad`, `Fecha_nacimiento`) VALUES
(1, 'Gabriel García Márquez', 'colombiano', '1927-03-06'),
(2, 'J.K. Rowling\r\n', 'Británica', '1965-07-31'),
...
--
-- Estructura de tabla para la tabla `prestamos_usuario`
--

CREATE TABLE `prestamos_usuario` (
...
--
-- Volcado de datos para la tabla `prestamos_usuario`
--

INSERT INTO `prestamos_usuario` (`ID_Relacion`, `ID_Prestamo`, `ID_Usuario`) VALUES
(1, 2, 1),
(2, 1, 2);
...
--
-- Indices de la tabla `prestamos_usuario`
--
ALTER TABLE `prestamos_usuario`
...
--
ALTER TABLE `autores`
  MODIFY `ID_Autores` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `prestamos_usuario`
--
ALTER TABLE `prestamos_usuario`
...
--
-- Filtros para la tabla `prestamos_usuario`
--
ALTER TABLE `prestamos_usuario`
  ADD CONSTRAINT `prestamos_usuario_ibfk_1` FOREIGN KEY (`ID_Prestamo`) REFERENCES `prestamos` (`ID_Prestamo`),
  ADD CONSTRAINT `prestamos_usuario_ibfk_2` FOREIGN KEY (`ID_Usuario`) REFERENCES `usuarios` (`ID_usuario`);
COMMIT;
